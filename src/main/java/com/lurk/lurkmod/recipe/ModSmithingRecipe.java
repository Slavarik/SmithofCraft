...
public class ModSmithingRecipe implements CraftingRecipe, net.minecraftforge.common.crafting.IShapedRecipe<CraftingContainer> {
    ...
    public ModSmithingRecipe(ResourceLocation pId, String pGroup, CraftingBookCategory pCategory, int pWidth, int pHeight, NonNullList<Ingredient> pRecipeItems, ItemStack pResult) {
        this.id = pId;
        this.group = pGroup;
    ...
    public static class Type implements RecipeType<ModSmithingRecipe> {
        private Type() { }
        public static final Type INSTANCE = new Type();
        public static final String ID = "mod_smithing";
    }
    ...
    public static class Serializer implements RecipeSerializer<ModSmithingRecipe> {
        private static final ResourceLocation NAME = new ResourceLocation(LurkMod.MODID);
        public static final Serializer INSTANCE = new Serializer();
        public ModSmithingRecipe fromJson(ResourceLocation pRecipeId, JsonObject pJson) {
            ...
            return new ModSmithingRecipe(pRecipeId, s, craftingbookcategory, i, j, nonnulllist, itemstack);
        }

        public ModSmithingRecipe fromNetwork(ResourceLocation pRecipeId, FriendlyByteBuf pBuffer) {
